...
export declare const ITEM_INFO_PROPERTIES: {
    type: boolean;
    groupKey: boolean;
    key: boolean;
    element: boolean;
...
export declare const INFINITEGRID_METHODS: readonly ["insertByGroupIndex", "updateItems", "getItems", "getVisibleItems", "getGroups", "getVisibleGroups", "renderItems", "getContainerElement", "getScrollContainerElement", "getWrapperElement", "setStatus", "getStatus", "removePlaceholders", "prependPlaceholders", "appendPlaceholders", "getStartCursor", "getEndCursor", "setCursors"];
