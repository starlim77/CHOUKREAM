...
const NewProducts = () => {
    ...
    useEffect(() => {
        axios
            .get(`http://localhost:8080/getNewProduct?seq=${seq}`)
    ...
    useEffect(() => {
        axios
            .get(
                `http://localhost:8080/getNewBrandList?seq=${seq}&brand=${form.brand}`,
            )
                    ...
                    <S.Content>
                        ...
                        <S.ColumnBind>
                            <S.ColumnIsFixed>
                                <>
                                    <U.ImgBody2>
                                        <U.MainImg2
                                            src={`/newProductList/${mainImg}`}
                                            alt={mainImg}
                                        ></U.MainImg2>
                                        {subImg1 && (
                                            <U.SmallImg2
                                                src={`/newProductList/${subImg0}`}
                                                id="0"
                        ...
                        <S.ProductDetailItemContent>
                            <S.ProductDetailTabWrap>
                                <S.ProductDetailTab>
                                    <S.TabActive onClick={onMoveToElement}>
                                        상품 상세정보
                                    </S.TabActive>
                                    <S.Tab onClick={onMoveToElement2}>
                                        교환 및 반품 안내
                                    </S.Tab>
                                    <S.Tab onClick={onMoveToElement4}>
                                        추천 상품
                                    </S.Tab>
                                </S.ProductDetailTab>
                            </S.ProductDetailTabWrap>
                                ...
                                <div>
                                    <S.DetailTitleHeaderImages>
                                        ...
                                        <S.DetailHeaderTitleWrap>
                                            <S.DetailHeaderProductNo>
                                                {form.newSeq}
                                            </S.DetailHeaderProductNo>
                                            <S.DetailHeaderTitle>
                                                <em>{form.title}</em>
                                            </S.DetailHeaderTitle>
                                            <S.DetailHeaderSubTitle>
                                                {form.subTitle}
                                            </S.DetailHeaderSubTitle>
                                        ...
                                        <S.DetailImgWrap>
                                            <S.DetailContentImages>
                                                <div className="images">
                                                    {desImg0 && (
                                                        <S.CoverImg
                                                            src={`/newProductList/${desImg0}`}
                                                        ></S.CoverImg>
                                                    )}
                                                    {desImg1 && (
                                                        <S.CoverImg
                                                            src={`/newProductList/${desImg1}`}
                                                        ></S.CoverImg>
                                                    )}
                                                    {desImg2 && (
                                                        <S.CoverImg
                                                            src={`/newProductList/${desImg2}`}
                                                        ></S.CoverImg>
                                                    )}
                                                </div>
                                            </S.DetailContentImages>
