...
//	문자를 보낼 핸드폰번호와 문자 내용을 입력하면 문자 전송이 완료됩니다.
	public void sendSms(String tel, String content) {
		...
		String serviceId = "ncp:sms:kr:296656816845:final1zo";       // 프로젝트에 할당된 SMS 서비스 ID							// service ID : https://console.ncloud.com/sens/project > Simple & ... > Project > 서비스 ID
