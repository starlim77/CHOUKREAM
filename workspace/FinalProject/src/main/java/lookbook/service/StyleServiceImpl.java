...
//		        Optional<StyleLikesEntity> findLikes = styleLikesDAO.findByMemberIdAndStyle_seq(memberId, style_seq);
//		       
...
//					System.out.println("임플 스트링 형변환 아이디 === "+id);
		            ...
		            System.out.println("임플의 styleEntity " +styleEntity);
		            ...
		            System.out.println("임플 styleLikesEntity === " +styleLikesEntity);
